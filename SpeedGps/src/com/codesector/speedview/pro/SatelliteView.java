...
class SatelliteView extends Button
{
    ...
    public SatelliteView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mPaintSat = new Paint();
        mBackground = ((BitmapDrawable)getResources().getDrawable(2130837533)).getBitmap();
        mSatellite = ((BitmapDrawable)getResources().getDrawable(2130837532)).getBitmap();
...
_L2:
        ...
        if(gpssatellite.getPrn() >= 0 && gpssatellite.getPrn() < 49)
            mSignalLevel[gpssatellite.getPrn()] = (int)Math.min(255F, 10F * gpssatellite.getSnr());
          goto _L1
    }
...
Couldn't fully decompile method setSatellites
	Exit status: 0
	Caught exceptions:
*/